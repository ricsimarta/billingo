...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartnerList', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.PartnerList();
      });

      it('should create an instance of PartnerList', function() {
        // TODO: update the code to test PartnerList
        expect(instance).to.be.a(BillingoApiV3.PartnerList);
      });
