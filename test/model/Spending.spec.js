...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Spending', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.Spending();
      });

      it('should create an instance of Spending', function() {
        // TODO: update the code to test Spending
        expect(instance).to.be.a(BillingoApiV3.Spending);
      });
