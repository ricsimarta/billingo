...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentBlockList', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.DocumentBlockList();
      });

      it('should create an instance of DocumentBlockList', function() {
        // TODO: update the code to test DocumentBlockList
        expect(instance).to.be.a(BillingoApiV3.DocumentBlockList);
      });
