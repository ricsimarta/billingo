...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentPartner', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.DocumentPartner();
      });

      it('should create an instance of DocumentPartner', function() {
        // TODO: update the code to test DocumentPartner
        expect(instance).to.be.a(BillingoApiV3.DocumentPartner);
      });
