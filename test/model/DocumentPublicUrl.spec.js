...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentPublicUrl', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.DocumentPublicUrl();
      });

      it('should create an instance of DocumentPublicUrl', function() {
        // TODO: update the code to test DocumentPublicUrl
        expect(instance).to.be.a(BillingoApiV3.DocumentPublicUrl);
      });
