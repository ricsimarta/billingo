...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentExportQueryType', function() {
      beforeEach(function() {
        instance = BillingoApiV3.DocumentExportQueryType;
      });

      it('should create an instance of DocumentExportQueryType', function() {
        // TODO: update the code to test DocumentExportQueryType
