...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendDocument', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.SendDocument();
      });

      it('should create an instance of SendDocument', function() {
        // TODO: update the code to test SendDocument
        expect(instance).to.be.a(BillingoApiV3.SendDocument);
      });
