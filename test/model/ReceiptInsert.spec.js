...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReceiptInsert', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.ReceiptInsert();
      });

      it('should create an instance of ReceiptInsert', function() {
        // TODO: update the code to test ReceiptInsert
        expect(instance).to.be.a(BillingoApiV3.ReceiptInsert);
      });
