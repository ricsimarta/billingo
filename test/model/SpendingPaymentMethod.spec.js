...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpendingPaymentMethod', function() {
      beforeEach(function() {
        instance = BillingoApiV3.SpendingPaymentMethod;
      });

      it('should create an instance of SpendingPaymentMethod', function() {
        // TODO: update the code to test SpendingPaymentMethod
