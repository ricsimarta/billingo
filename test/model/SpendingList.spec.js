...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SpendingList', function() {
      beforeEach(function() {
        instance = new BillingoApiV3.SpendingList();
      });

      it('should create an instance of SpendingList', function() {
        // TODO: update the code to test SpendingList
        expect(instance).to.be.a(BillingoApiV3.SpendingList);
      });
